        ...
        MedicalRecord.findOneAndUpdate(
            { _id: medicalrecord._id },
            {
                $set: {
                    ...
                    'anamnesis.bpm': req.body.anamnesis.bpm,
        ...
        MedicalRecord.findOneAndUpdate(
            { _id: medicalrecord._id },
            {
                $set: {
                    ...
                    'neurologic.rf.a': req.body.neurologic.rf.a,
                    'neurologic.rf.b': req.body.neurologic.rf.b,
                    'neurologic.rf.c': req.body.neurologic.rf.c,
                    'neurologic.rf.d': req.body.neurologic.rf.d,
                    'neurologic.rp.a': req.body.neurologic.rp.a,
                    'neurologic.rp.b': req.body.neurologic.rp.b,
                    'neurologic.rp.c': req.body.neurologic.rp.c,
                    'neurologic.rp.d': req.body.neurologic.rp.d,
